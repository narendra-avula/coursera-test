...
angular.module("DIApp",[]).controller("DIController",["$scope","$filter",e])}();

!function(){"use strict";function e(e,n){e.name="Yaakov",e.upper=function(){var o=n("uppercase");e.name=o(e.name)}}
